        ...
        <div class="content">
            <div class="tabs">
                <ul class="tab-links ul">
                    <li class="li active"><a class="tab" href="javascript:void(0)">Stronghold: Crusader</a></li>
                ...
                <div class="tab-content">
                    <div id="Main_tab" class="tb_act">
                        ...
                        <div class="scroll" style=" background: url(./images/covers/gamecover10.jpg); -webkit-background-size: 100% 100%;">
                        </div>
                        </div>
