        ...
        <div class="content">
            <div class="tabs">
                <ul class="tab-links ul">
                    <li class="li active"><a class="tab" href="javascript:void(0)">Project I.G.I.: I'm Going In</a></li>
                ...
                <div class="tab-content">
                    <div id="Main_tab" class="tb_act">
                        ...
                        <div class="scroll" style=" background: url(./images/covers/gamecover5.jpg); -webkit-background-size: 100% 100%;">
                        </div>
                        </div>
...
It was followed up in 2003 by I.G.I.-2: Covert Strike.
                                ...
                                <br>
                                <b>Price:</b> &nbsp&nbsp&nbsp<span>$250</span>
                                <br>
