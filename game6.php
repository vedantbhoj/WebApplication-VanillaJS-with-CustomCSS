        ...
        <div class="content">
            <div class="tabs">
                <ul class="tab-links ul">
                    <li class="li active"><a class="tab" href="javascript:void(0)">Assassin's Creed II</a></li>
                ...
                <div class="tab-content">
                    <div id="Main_tab" class="tb_act">
                        ...
                        <div class="scroll" style=" background: url(./images/covers/gamecover6.jpg); -webkit-background-size: 100% 100%;">
                        </div>
                        </div>
                        <div class="page_container" id="GameDescDiv" style="width:760px;float:right;box-shadow: 0px 0px 3px 5px #B0BEC5;">
                            <div class="scroll" style="padding: 15px 20px 0 30px;">
                                ...
                                <br>
                                <b>Price:</b> &nbsp&nbsp&nbsp<span>$270</span>
                                <br>
